...
public class DisplayMarksStudent {
    ...
    void run(int studentid) {
        ...
        frame = new JFrame("View marks of all subjects");
        panel = new JPanel();
    ...
    void fillCentralPanel(JPanel centralPanel) {
        ...
        try {
            ...
            String query = "SELECT subject.subjectname, marks.marks FROM subject, marks WHERE subject.subjectid = marks.subjectid AND marks.studentid = ?";
