...
public class DisplayAttendanceInstructor {
    ...
    void run(int subjectid) {
        ...
        frame = new JFrame("View attendance of all students");
        panel = new JPanel();
    ...
    void fillCentralPanel(JPanel centralPanel) {
        ...
        try {
            ...
            String query = "SELECT student.studentname, attendance.attendance FROM student, attendance WHERE student.studentid = attendance.studentid AND attendance.subjectid = ?";
